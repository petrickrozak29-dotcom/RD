  ...
  return (
    <GradientBg>
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 text-white sm:px-6 lg:py-16">
        ...
        <p className="mt-4 text-slate-300">Kumpulan sumber data, API, dan dokumentasi terkait Smart Magelang dan integrasi sistem.</p>
        ...
        <section className="mt-8 space-y-6">
          <article className="rounded-lg border border-slate-800 bg-slate-900/80 p-6">
            ...
            <p className="mt-2 text-slate-300">Endpoint: <code className="rounded bg-slate-800 px-2 py-0.5">/api/*</code> — gunakan untuk mengambil data Wisata, Kuliner, dan Event.</p>
          </article>
